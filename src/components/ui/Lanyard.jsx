...
export default function Lanyard({ position = [0, 0, 30], gravity = [0, -40, 0], fov = 20, transparent = true }) {
  ...
  if (error) {
    return <div className="relative z-0 w-full h-[80vh] flex justify-center items-center" />;
  }

  return (
    <div className="relative z-0 w-full h-[80vh] flex justify-center items-center transform -mt-4 scale-100 origin-center ">
      <Canvas camera={{ position: position, fov: fov }} dpr={[1, isMobile ? 1.5 : 2]} gl={{ alpha: transparent }} onCreated={({ gl }) => gl.setClearColor(new THREE.Color(0x000000), transparent ? 0 : 1)} onError={() => setError(true)}>
