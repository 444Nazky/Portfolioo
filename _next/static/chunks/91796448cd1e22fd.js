...
, 50740, (e, t, r) => {
    ...
    function H(e, t, r) {
        ...
        return !function e(t, r, n, i, l) {
            ...
            if (d)
                ...
                s = n + (null == l.key || t && t.key === l.key ? "" : ("" + l.key).replace(M, "$&/") + "/") + d,
                l = P(a.type, s, a.props)),
                r.push(l)),
                1;
            d = 0;
            var p = "" === i ? "." : i + ":";
    ...
    function N(e) {
        ...
        try {
            var n = e()
              , o = T.S;
            null !== o && o(r, n),
            "object" == typeof n && null !== n && "function" == typeof n.then && n.then(x, U)
        } catch (e) {
            U(e)
        } finally {
    ...
    r.cloneElement = function(e, t, r) {
        ...
        if (null != t)
            ...
            t)
                R.call(t, u) && "key" !== u && "__self" !== u && "__source" !== u && ("ref" !== u || void 0 !== t.ref) && (n[u] = t[u]);
        var u = arguments.length - 2;
        if (1 === u)
            n.children = r;
        else if (1 < u) {
            for (var i = Array(u), l = 0; l < u; l++)
                i[l] = arguments[l + 2];
            n.children = i
        }
        return P(e.type, o, n)
